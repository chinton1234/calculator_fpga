...
HD_PWD='C:/Users/Acer/Documents/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calculator_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calculator_system.tcl
