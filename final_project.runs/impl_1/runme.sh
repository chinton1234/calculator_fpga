...
HD_PWD='C:/Users/Acer/Documents/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log calculator_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source calculator_system.tcl -notrace
